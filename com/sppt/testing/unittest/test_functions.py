...
# ----------------- Error/Exception Handling start------------
    def test_divide_error_on_zero(self):
        with self.assertRaises(ValueError):
            divide(25, 0)

    def test_divide_error_on_zero_style2(self):
    ...
    def test_multiply_result(self):
        inputs = (3, 5)
        expected = 15
        self.assertEqual(multiply(*inputs), expected)   # *input <-- means pass the values of tuple as argument one by one
